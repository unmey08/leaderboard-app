  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-md max-h-full">
        <button
          type="button"
          className="absolute z-100 left-5/6 top-2 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white hover:cursor-pointer"
          data-modal-toggle="crud-modal"
          onClick={() => setShowUserModal(false)}
        >
          <FontAwesomeIcon icon={faClose} size="xl" />
        </button>
        <div className="flex flex-col items-center relative p-24 w-full max-w-md max-h-full bg-white rounded-lg shadow-sm dark:bg-neutral-800 dark:border-neutral-100">
